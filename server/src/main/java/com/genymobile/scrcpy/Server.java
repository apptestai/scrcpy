...
public final class Server {
    ...
    private static void parseArguments(Options options, VideoSettings videoSettings, String... args) {
        ...
        // MODIFIED FROM WS-SCRCPY : Added websocket options
        ...
        // MODIFIED FROM WS-SCRCPY : Set video settings
    ...
    public static void main(String... args) throws Exception {
        ...
        // MODIFIED FROM WS-SCRCPY : Creates new connection. Either in webSocket or local
