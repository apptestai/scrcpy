...
public final class DesktopConnection extends Connection {
    ...
    // MODIFIED FROM WS-SCRCPY : Creating new desktop connection is now 
    //
    ...
    public DesktopConnection(Options options, VideoSettings videoSettings) throws IOException {
        ...
        //MODIFED FROM SCRCPY : Not only setting connections, but also starts encoding when there is a new connection.
        controlInputStream = controlSocket.getInputStream();
        controlOutputStream = controlSocket.getOutputStream();
        videoFd = videoSocket.getFileDescriptor();
    ...
    // ADDED FROM WS-SCRCPY : Sends encoded video buffer to client
    ...
    // ADDED FROM WS-SCRCPY : Launches controller
